 ...
 * @author NGHIA_PC
 */
public class DSHoso extends javax.swing.JFrame {
    ...
    public void fillTable()
    {
        ...
        model.setNumRows(0);
        for (Hoso tk :new HosoDAO().getListHoso())
        {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Danh sách hồ sơ");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "STT", "IDhoso", "SDTbn", "Mã bệnh", "IDbs", "Tổng tiền", "Ngày tạo"
            }
        ));
        jScrollPane1.setViewportView(jTable1);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 170, 720, 230));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DSHoso.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
