...
public class CheckUpdate extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Cập nhật ứng dụng");
        ...
        jTextArea1.setText("Chào mừng bạn đến với Trình cài đặt của Nha Khoa Tut Tat\n\nTrình cài đặt sẽ tải xuống, xác minh và sau đó cài đặt các bổ sung đã chọn.\n\n-------------\n\nPhiên bản của bạn đang là mới nhất.\n\nHiện tại không có bản cập nhật có sẵn nào!\n\n");
        jScrollPane1.setViewportView(jTextArea1);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 150, 630, 370));
